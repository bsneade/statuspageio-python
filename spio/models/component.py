...
class Component(object):
    ...
    def __init__(self, id=None, page_id=None, group_id=None, created_at=None, updated_at=None, group=None, name=None, description=None, position=None, status=None, showcase=None, only_show_if_degraded=None, automation_email=None, local_vars_configuration=None):  # noqa: E501
