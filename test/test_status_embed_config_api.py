...
class TestStatusEmbedConfigApi(unittest.TestCase):
    ...
    def test_get_pages_page_id_status_embed_config(self):
        """Test case for get_pages_page_id_status_embed_config

        Get status embed config settings  # noqa: E501
        """
        pass

    def test_patch_pages_page_id_status_embed_config(self):
        """Test case for patch_pages_page_id_status_embed_config

        Update status embed config settings  # noqa: E501
        """
        pass

    def test_put_pages_page_id_status_embed_config(self):
        """Test case for put_pages_page_id_status_embed_config
